...
export default function ArticleReader({ articleId, onBack, onNavigateToArticle }: ArticleReaderProps) {
  ...
  return (
    <article className="min-h-screen bg-[#FAF8F5] text-[#2C2A27] pt-24 pb-36 px-4 md:px-8">
                ...
                <div className="lg:col-span-5 bg-[#FAF8F5] border border-[#E8E2D8]/50 rounded-2xl p-8 relative overflow-hidden flex flex-col items-center">
                  <div className="relative w-full max-w-[240px]">
                    ...
                    <svg viewBox="0 0 320 420" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
                      ...
                      <path d="M154 122 C158 114 162 114 166 122 C170 130 150 130 154 122 Z M150 125 C154 125 154 119 158 119 C162 119 162 125 166 125" stroke="#6E7E70" strokeWidth="1.5" fill="none" strokeLinecap="round" />
                      
                      <path d="M140 182 H180 V196 H140 Z M144 175 H176 V182 H144 Z M150 196 H170 V199 H150 Z" stroke="#C67A63" strokeWidth="1.8" fill="none" strokeLinejoin="round" />
                      <line x1="160" y1="175" x2="160" y2="196" stroke="#C67A63" strokeWidth="1.5" />
                      
                      <rect x="138" y="240" width="16" height="16" rx="2" transform="rotate(18 138 240)" stroke="#6E7E70" strokeWidth="1.8" fill="none" />
                      <path d="M144 242 L150 248" stroke="#6E7E70" strokeWidth="1" opacity="0.6" />
                      <rect x="156" y="246" width="16" height="16" rx="2" transform="rotate(-12 156 246)" stroke="#6E7E70" strokeWidth="1.8" fill="none" />
                      <path d="M160 250 L166 256" stroke="#6E7E70" strokeWidth="1" opacity="0.6" />
                      ...
                      <path d="M100 156 C120 136 138 130 160 130 C182 130 200 136 220 156 C234 176 238 210 238 265 L82 265 C82 210 86 176 100 156 Z" fill="#E8E2D8" opacity="0.5" stroke="#D3CFC7" strokeWidth="1.5" />
                    </svg>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-5 bg-[#FAF8F5] border border-[#E8E2D8]/50 rounded-2xl p-6 flex flex-col items-center">
                  <div className="relative w-full h-[320px] bg-white border border-[#E8E2D8] rounded-xl overflow-hidden shadow-xs">
                    ...
                    <div className="absolute inset-0 grid grid-cols-8 grid-rows-6 z-30">
            ...
            <section className="bg-white border border-[#E8E2D8] rounded-[22px] p-8 md:p-14 shadow-xs text-left">
              <header className="max-w-3xl mx-auto text-center mb-12 border-b border-[#E8E2D8]/60 pb-6">
                ...
                <p className="text-sm font-light text-[#68635E] leading-relaxed max-w-2xl mx-auto">
                  A nossa mente funciona como uma estante viva. Com o passar do tempo, guardamos certos aspectos da vida nas prateleiras de cima e acabamos empurrando outros para trás de forma automática.
                </p>
                <p className="text-xs italic text-[#948E85] mt-4 bg-[#F9F8F6] py-2 px-4 rounded-xl border border-[#E8E2D8]/40 inline-block">
                  Instruções: Arraste os cartões de "Cartões Disponíveis" para as prateleiras na direita. Se estiver no celular, dê um toque sobre o cartão e depois um toque na prateleira de destino escolhida.
                </p>
              </header>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 flex flex-col gap-3">
                  ...
                  <div 
                    ...
                    className={`bg-[#F9F8F6] border border-[#E8E2D8] rounded-2xl p-6 min-h-[250px] flex flex-wrap gap-2.5 items-start content-start justify-start transition-all duration-300 cursor-pointer ${selectedShelfCard ? 'ring-2 ring-[#768D7C]/20 bg-[#768D7C]/5' : ''}`}
                  >
                    {shelfPool.map(card => (
                      <div
                        key={card.id}
                        ...
                        className={`w-[230px] shrink-0 justify-center text-center px-4 py-2 border rounded-full text-xs font-medium cursor-grab select-none inline-flex items-center gap-2 transition-all duration-300 ${selectedShelfCard?.id === card.id ? 'bg-[#768D7C] text-white border-[#768D7C]' : 'bg-white border-[#E8E2D8] text-[#3A3530] hover:border-[#768D7C] hover:shadow-xs'}`}
                      >
                        <span className="opacity-50 font-sans text-[10px] tracking-tighter">⋮⋮</span>
                        {card.label}
                      </div>
                    ))}
                    {shelfPool.length === 0 && (
                ...
                <div className="lg:col-span-7 flex flex-col gap-6">
                  ...
                  <div className="border border-[#E8E2D8] rounded-2xl p-5 bg-white shadow-xs">
                    ...
                    <div
                      ...
                      onClick={() => handleZoneClick('max')}
                      className={`min-h-[70px] p-3 border-2 border-dashed border-[#D6CFC4] rounded-xl flex flex-wrap gap-2 items-start content-start justify-start bg-[#F9F8F6]/50 transition-colors duration-300 cursor-pointer hover:bg-[#F0F4F1] hover:border-[#768D7C]`}
                    >
                      {shelfMax.map(card => (
                        <div
                          key={card.id}
                          ...
                          className={`w-[230px] shrink-0 justify-center text-center px-3 py-1.5 border rounded-full text-xs cursor-grab select-none inline-flex items-center gap-1.5 transition-all duration-300 ${selectedShelfCard?.id === card.id ? 'bg-[#768D7C] text-white border-[#768D7C]' : 'bg-white border-[#E8E2D8] text-[#3A3530] hover:border-[#768D7C]'}`}
                        >
                  ...
                  <div className="border border-[#E8E2D8] rounded-2xl p-5 bg-white shadow-xs">
                    ...
                    <div
                      ...
                      onClick={() => handleZoneClick('mid')}
                      className={`min-h-[70px] p-3 border-2 border-dashed border-[#D6CFC4] rounded-xl flex flex-wrap gap-2 items-start content-start justify-start bg-[#F9F8F6]/50 transition-colors duration-300 cursor-pointer hover:bg-[#FAF6EE] hover:border-[#E2B05C]`}
                    >
                      {shelfMid.map(card => (
                        <div
                          key={card.id}
                  ...
                  <div className="border border-[#E8E2D8] rounded-2xl p-5 bg-white shadow-xs">
                    ...
                    <div
                      onDragOver={(e) => e.preventDefault()}
                      onDrop={(e) => handleDrop(e, 'min')}
                      onClick={() => handleZoneClick('min')}
                      className={`min-h-[70px] p-3 border-2 border-dashed border-[#D6CFC4] rounded-xl flex flex-wrap gap-2 items-start content-start justify-start bg-[#F9F8F6]/50 transition-colors duration-300 cursor-pointer hover:bg-[#FBF1EF] hover:border-[#C47D68]`}
                    >
                      {shelfMin.map(card => (
                        <div
                          key={card.id}
              ...
              {shelfResultCalculated && (
                <div className="mt-12 border-t border-[#E8E2D8] pt-10 animate-fade-in text-left">
                  ...
                  <div className="flex flex-col items-center mt-10">
                    <a 
                      href="https://wa.me/5512991766972?text=Olá!%20Finalizei%20o%20mapeamento%20da%20minha%20Prateleira%20Mental%20e%20gostaria%20de%20compreender%20melhor%20minhas%20prioridades%20e%20organizar%20minha%20rotina%20na%20terapia."
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-[#C47D68] hover:bg-[#b06d59] text-white text-sm font-medium px-8 py-3.5 rounded-full shadow-xs hover:shadow-md transition-all duration-300 text-center"
                    >
                      Quero organizar melhor minha rotina na terapia
                    </a>
                  </div>
            ...
            <section className="bg-white border border-[#E8E2D8] rounded-[22px] p-8 md:p-14 shadow-xs text-left">
              ...
              <div className="bg-[#FAF8F6] border border-[#E8E2D8] rounded-2xl p-8 flex flex-col gap-10">
                ...
                <div className="relative w-full py-4">
                  ...
                  <div className="absolute top-[34px] left-[40px] right-[40px] h-1 bg-[#E2DBD0] rounded-full z-10" />
                  
                  {/* Active progress track line */}
                  <div 
                    className="absolute top-[34px] left-[40px] h-1 bg-[#768D7C] rounded-full z-20 transition-all duration-500 ease-in-out" 
                    style={{ width: `calc(${(autismTimelineIndex / 3) * 100}% - ${(autismTimelineIndex / 3) * 80}px)` }}
                  />
                  ...
                  <div className="relative flex justify-between z-30">
                    {[
                      ...
                      <button
                        ...
                        className="group flex flex-col items-center w-24 focus:outline-none cursor-pointer"
                      >
                        {/* Node Ring */}
                        <div 
                        ...
                        {/* Node Text */}
                        <span 
                          className={`text-[0.72rem] md:text-xs font-semibold mt-3 transition-colors duration-300 ${idx <= autismTimelineIndex ? 'text-[#3A3530]' : 'text-[#A39E93] group-hover:text-[#6E7E70]'}`}
                        >
                          {node.label}
                        </span>
                      </button>
                  ...
                  <input 
                    ...
                    className="absolute inset-x-[40px] top-[14px] h-[40px] opacity-0 cursor-pointer z-40"
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[95%] max-w-2xl z-40 bg-[#FAF8F5]/98 backdrop-blur-md border border-[#E8E2D8] py-3.5 px-6 rounded-2xl md:rounded-full shadow-[0_12px_40px_rgba(44,43,41,0.15)] transition-all duration-300">
