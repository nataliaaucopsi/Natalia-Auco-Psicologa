...
<head>
  ...
  <title>Natália Auco - Psicologia Clínica Premium</title>
...
<body class="paper-texture min-h-screen pt-16">
  ...
  <nav class="fixed top-0 left-0 right-0 bg-[#FAF8F5]/95 backdrop-blur-md border-b border-[#E8E2D8] py-3.5 shadow-sm z-40 transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
      ...
      <div class="hidden lg:flex items-center gap-4">
        ...
        <a href="https://wa.me/5512991766972" target="_blank" class="bg-[#607762] hover:bg-[#4a5d4e] text-white text-[10px] font-bold px-4 py-2.5 rounded-full transition-all duration-300 uppercase tracking-wider text-center flex items-center justify-center min-w-[140px]">Agendar Consulta</a>
      </div>
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-[#FAF8F5] border-t border-[#E8E2D8] px-5 py-4 transition-all duration-300">
      <div class="flex flex-col gap-3">
        ...
        <a href="https://wa.me/5512991766972" target="_blank" class="bg-[#607762] text-white text-center py-2.5 rounded-full font-bold uppercase tracking-wider text-[11px] mt-1 flex items-center justify-center">Agendar Consulta</a>
      </div>
    </div>
  </nav>
  ...
  <section class="py-20 md:py-28 bg-[#F5F0E9] border-t border-[#E8E2D8] scroll-mt-12 overflow-hidden" id="aplicativo-exclusivo">
    <div class="max-w-7xl mx-auto px-4 md:px-8">
      ...
      <div class="text-center max-w-3xl mx-auto mb-12">
        ...
        <h2 class="font-serif text-3.5xl md:text-5xl text-[#2C2B29] leading-tight font-medium">
          Aplicativo Exclusivo da Clínica
        </h2>
  ...
  <footer class="border-t border-[#E8E2D8] py-16 text-center text-xs text-[#8C8273] font-medium tracking-wide space-y-4">
    ...
    <div class="pt-4 text-[10px] text-neutral-400">Desenvolvido com excelência técnica para Google Sites</div>
  </footer>
        ...
        <div className="fixed inset-0 bg-[#2C2A27]/60 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fade-in">
          ...
          <div className="relative w-full max-w-3xl bg-[#f3eee7] border border-[#E8E2D8] rounded-[28px] p-6 md:p-10 shadow-2xl flex flex-col max-h-[90vh] z-10 animate-scale-up">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="font-serif text-2xl md:text-3xl font-semibold text-[#2C2A27]">
                  Código Unificado para Google Sites
                </h3>
                <p className="text-xs text-[#7A8B7C] font-semibold uppercase tracking-wider mt-1">
                  100% Responsivo • Links Corrigidos • Atendimento Premium
                </p>
              </div>
              <button 
                onClick={() => setIsOpen(false)}
            ...
            <div className="bg-[#FAF8F5] border border-[#F1ECE5] rounded-xl p-4 text-xs text-[#5D5A56] leading-relaxed mb-6 space-y-2">
              <p>
                <strong>✓ Solução de Links Corrigida:</strong> Todo o conteúdo dos artigos agora carrega em uma janela deslizante integrada. Isso resolve de forma definitiva o problema do Google Sites de abrir abas vazias ou quebrar o iframe!
              </p>
              <p>
                <strong>✓ Como utilizar:</strong> No painel do Google Sites, clique em <strong>Incorporar</strong> &rarr; escolha a aba <strong>Incorporar código</strong> &rarr; cole o código. Expanda o container para ocupar a largura total e toda a altura do site.
              </p>
              <p className="text-amber-800 bg-amber-50 border border-amber-200/60 rounded-lg p-2 mt-2">
                <strong>💡 Dica Importante contra Truncamento:</strong> Se o botão de cópia automática falhar devido às permissões rígidas de segurança do seu navegador dentro deste visualizador, use o botão <strong>"Baixar (.html)"</strong> abaixo. Depois, basta abrir o arquivo baixado no Bloco de Notas, pressionar <code>Ctrl+A</code> e <code>Ctrl+C</code>, e colar no Google Sites! Isso garante que 100% do código seja copiado perfeitamente sem nenhuma perda ou corte.
              </p>
            </div>
